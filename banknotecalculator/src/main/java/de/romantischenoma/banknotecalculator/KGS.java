...
public class KGS extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        resultTotal = result5000 + result2000;
        tv2000.setText(" " + result2000);
        tvTotal.setText(" " + resultTotal);

        num1000 = Integer.parseInt(et1000.getText().toString());
        result1000 = 1000 * num1000;
        resultTotal = result5000 +  result2000 + result1000;
        tv1000.setText(" " + result1000);
        tvTotal.setText(" " + resultTotal);

        num500 = Integer.parseInt(et500.getText().toString());
        result500 = 500*num500;
        resultTotal = result5000 + result2000 + result1000 + result500;
        tv500.setText(" " + result500);
        tvTotal.setText(" " + resultTotal);

        num200 = Integer.parseInt(et200.getText().toString());
        result200 = 200*num200;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200;
        tv200.setText(" " + result200);
        tvTotal.setText(" " + resultTotal);

        num100 = Integer.parseInt(et100.getText().toString());
        result100 = 100*num100;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100;
        tv100.setText(" " + result100);
        tvTotal.setText(" " + resultTotal);

        num50 = Integer.parseInt(et50.getText().toString());
        result50 = 50*num50;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50;
        tv50.setText(" " + result50);
        tvTotal.setText(" " + resultTotal);

        num20 = Integer.parseInt(et20.getText().toString());
        result20 = 20*num20;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20;
        tv20.setText(" " + result20);
        tvTotal.setText(" " + resultTotal);

        num10 = Integer.parseInt(et10.getText().toString());
        result10 = 10*num10;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10;
        tv10.setText(" " + result10);
        tvTotal.setText(" " + resultTotal);

        num5 = Integer.parseInt(et5.getText().toString());
        result5 = 5*num5;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5;
        tv5.setText(" " + result5);
        tvTotal.setText(" " + resultTotal);

        num3 = Integer.parseInt(et3.getText().toString());
        result3 = 3*num3;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5 + result3;
        tv3.setText(" " + result3);
        tvTotal.setText(" " + resultTotal);

        num1 = Integer.parseInt(et1.getText().toString());
        result1 = 1*num1;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5 + result3 + result1;
        tv1.setText(" " + result1);
        tvTotal.setText(" " + resultTotal);

        num050 = Integer.parseInt(et050.getText().toString());
        result050 = 0.5*num050;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5 + result3 + result1 + result050;
        ...
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5 + result3 + result1 + result050 + result010;
        tv010.setText(" " + Math.round(result010*10.0)/10.0);
        tvTotal.setText(" " + Math.round(resultTotal*10.0)/10.0);

        num001 = Integer.parseInt(et001.getText().toString());
        result001 = 0.01*num001;
        resultTotal = result5000 +  result2000 + result1000 + result500 + result200 + result100 + result50 + result20 + result10 + result5 + result3 + result1 + result050 + result010 + result001;
        ...
        tvTotal.setText(" " + Math.round(resultTotal*100.0)/100.0);
            ...
            tvTotal.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    et001.setText("0");
                    tv001.setText("");
                    tvTotal.setText("Тазалоо үчүн ушул жерди баскыла");
                }
            });
        }
